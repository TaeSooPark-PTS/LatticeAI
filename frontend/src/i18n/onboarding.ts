...
export const onboardingCopy: NamespaceCopy = {
  ko: {
    ...
    "flow.recommend.embedHint": "검색은 대화 모델과 별개입니다. 의미 모델이 없으면 해시 검색으로 시작합니다.",
  ...
  en: {
    ...
    "flow.recommend.embedHint": "Search is separate from the chat model. Without a meaning model, Lattice starts with hash search — not semantic recall.",
