...
export const COPY: Record<Language, TextMap> = {
  ko: {
    ...
    "brain.home.kicker": "나의 Lattice",
    "brain.home.insights": "Brain이 정리한 내용",
    "brain.home.insights.detail": "기억, 연결, 다음 행동을 필요할 때 확인하세요",
    "brain.firstScreen.title": "무엇을 함께 해볼까요?",
    "brain.firstScreen.body": "질문하거나, 생각을 정리하거나, 자료에서 필요한 내용을 찾아보세요.",
  ...
  en: {
    ...
    "brain.firstScreen.title": "What shall we work on together?",
    "brain.firstScreen.body": "Ask a question, organize a thought, or find what you need in your sources.",
