...
export const COPY: Record<Language, TextMap> = {
  ko: {
    ...
    "brain.chatHome.body": "질문을 입력하거나 문서를 넣으면 Brain이 기억과 자료를 함께 보며 도와드립니다.",
  ...
  en: {
    ...
    "brain.chatHome.body": "Ask a question or add a document. Your Brain will use memory and sources together.",
