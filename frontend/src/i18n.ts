...
export const COPY: Record<Language, TextMap> = {
  ko: {
    ...
    "brain.brief.kicker": "Brain Brief",
  ...
  en: {
    ...
    "brain.brief.evidence.durable": "durable",
    "brain.brief.evidence.durable.detail": "Local memories that stay available across model switches",
    ...
    "brain.brief.action.verify.detail": "Check model-independent recall",
