...
export const COPY: Record<Language, TextMap> = {
  ko: {
    ...
    "brain.tab.memory": "기억",
    "brain.tab.knowledge": "지식",
    "brain.tab.relationships": "관계",
    "brain.tab.graph": "그래프",
    "brain.tab.portability": "돌보기",
    "brain.headline.conversation": "Brain과 대화하세요.",
    "brain.headline.memory": "기억 — 기계 이전에 먼저.",
    "brain.headline.knowledge": "지식 — 떠올릴 수 있게 모은 것.",
    "brain.headline.relationships": "관계 — 왜 그런지 알 때.",
    "brain.headline.graph": "그래프 — 의도적으로 펼쳐 봅니다.",
  ...
  en: {
    ...
    "brain.headline.memory": "Memories, before mechanics.",
    "brain.headline.knowledge": "Knowledge, gathered into recall.",
    "brain.headline.relationships": "Relationships, when you need the why.",
    "brain.headline.graph": "The graph, intentionally opened.",
