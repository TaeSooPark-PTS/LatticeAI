...
The 9.4.0 first-run and daily-use flow is:
...
The 8.0 architecture contract remains active in 9.4.0:
...
default live KnowledgeGraphStore backend in 9.4.0. Backups and `.latticebrain`
