...
def test_v77_product_readiness_is_machine_checkable():
    report = product_readiness(ROOT)
    assert report["version_target"] == "7.7.0"
...
def test_v77_product_is_release_complete():
    report = product_readiness(ROOT)
...
def test_v77_score_reflects_gate_counts():
    report = product_readiness(ROOT)
