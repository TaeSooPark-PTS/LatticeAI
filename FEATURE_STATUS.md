# Lattice AI Feature Status (v11.8.0)
...
| Release Assets | Current | 11.8.0 package metadata, static app, release notes, current documentation, and exact artifact names are aligned. The macOS dmg is ad-hoc signed (effectively unsigned), as in every release so far. |
