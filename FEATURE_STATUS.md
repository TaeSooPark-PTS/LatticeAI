# Lattice AI Feature Status (v10.2.0)
...
| Release Assets | Current | 10.2.0 package metadata, static app, release notes, current documentation, and exact artifact names are aligned. |
