...
- `PyPI`: `ltcai==0.1.21`
- `npm`: `ltcai@0.1.21`
- `VS Code Marketplace`: `parktaesoo.ltcai@0.1.21`
- `Open VSX`: `parktaesoo.ltcai@0.1.21`
...
`0.1.21 릴리스는 아래 네 채널을 동일 버전으로 맞춥니다.
...
현재 버전: **0.1.21** — 자세한 변경 이력은 [docs/CHANGELOG.md](docs/CHANGELOG.md) 참고.
