...
[![VS Code](https://img.shields.io/visual-studio-marketplace/v/parktaesoo.ltcai?label=VS%20Code&logo=visualstudiocode&color=blue)](https://marketplace.visualstudio.com/items?itemName=parktaesoo.ltcai)
