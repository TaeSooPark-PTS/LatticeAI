...
//! the agent sandbox ([`crate::governance::change_proposals`] — the worker seam it used to
...
//! mutation — while [`crate::workspaceos::workspace::WorkspaceOsStore`] wrote the same file
