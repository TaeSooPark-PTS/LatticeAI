...
//! reports **CPython's own decoder text** through [`crate::pyjson`], and the
//! character-exact slicing this port needs is [`crate::pystr`] — both live in
...
//! * **`json.loads` accepts `NaN`/`Infinity`; [`crate::pyjson`] does not.**
//!
//! ## Layout
//!
