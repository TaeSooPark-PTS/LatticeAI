...
Lattice AI v8.1.0는 모델이 바뀌어도 사용자의 지식과 맥락을 보존하는 local-first Digital Brain입니다. Personal /
...
installs를 포함합니다. v8.1.0은 v6.4.0의 workspace-scoped graph/search/memory
...
secret redaction을 로그/감사/보안 export/hook packet에 중앙 적용합니다. v8.1.0은
...
불필요하게 모두 적재되지 않게 합니다. 8.1.0은 기본 Brain Chat Home에서 채팅/입력/시작 프롬프트를
