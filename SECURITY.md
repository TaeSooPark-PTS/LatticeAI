...
Lattice AI v6.6.0는 모델이 바뀌어도 사용자의 지식과 맥락을 보존하는 local-first Digital Brain입니다. Personal /
...
installs를 포함합니다. v6.6.0는 v6.4.0의 workspace-scoped graph/search/memory
