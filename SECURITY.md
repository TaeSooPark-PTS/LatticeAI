...
The public Git tree keeps release history from 8.0.0 through 9.5.0. Security
support follows that same product era.

| Version | Support |
| --- | --- |
| 9.5.x (latest) | Supported |
| 9.4.x | Supported |
| 9.3.x | Supported |
| 9.2.x | Supported |
| 9.1.x | Supported |
...
Lattice AI v9.5.0 is a local-first Digital Brain. It keeps user knowledge,
