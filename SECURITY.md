...
The public Git tree keeps release history from 7.0.0 through 8.1.0. Security
support follows that same product era.

| Version | Support |
| --- | --- |
| 8.1.x (latest) | Supported |
| 8.0.x | Supported |
| 7.9.x | Supported |
| 7.8.x | Supported |
| 7.7.x | Supported |
...
Lattice AI v8.1.0 is a local-first Digital Brain. It keeps user knowledge,
