...
**5.5.0 — Release Coordination.** The extension follows the main
...
drafts with scheduler triggers from the preserved v5.4.0 baseline, while
extension package metadata is synchronized to 5.5.0.
