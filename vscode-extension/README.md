...
**7.7.0 — Complete Finished Product.** The extension follows
...
separated Admin surface used by the desktop app. The v7.7.0 line aligns the extension with the main app product command center, repaired Review Center evidence, exact release artifacts, and machine-checkable product readiness gates while preserving the visible VS Code sync status.
