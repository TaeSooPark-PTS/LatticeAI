...
**8.2.0 — Brain Brief.** The extension follows
...
separated Admin surface used by the desktop app. The v8.2.0 line aligns the
extension with the evidence-backed Brain Brief, exact release artifacts, and
