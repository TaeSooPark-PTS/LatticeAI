# v9.0.0 Release Evidence

Captured from the built React/Vite app served by the release visual API for the 9.0.0 documentation baseline.
...
- [v9.0.0-living-brain-walkthrough.webm](videos/v9.0.0-living-brain-walkthrough.webm)
- [v9.0.0-living-brain-walkthrough.gif](gifs/v9.0.0-living-brain-walkthrough.gif)
